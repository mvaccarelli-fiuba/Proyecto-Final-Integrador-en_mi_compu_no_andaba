...
def get_disponibilidad():
    ...
    if not cantidad_personas or not fecha:
        return error(
            "400",
            "Bad request",
            "El parametro cantidad_personas y fecha son obligatorios",
            400,
        )
    ...
    try:
        ...
        return error(
            "500",
            "Internal Server Error",
            f"Ocurrio un error al obtener la disponibilidad: {err}",
            500,
        )
...
def create_reserva():
    ...
    try:
        ...
        return (
            jsonify({"message": "Reserva creada correctamente", "data": reserva}),
            201,
        )
        ...
        return error(
            "500",
            "Internal Server Error",
            f"Ocurrió un error al crear la reserva: {err}",
            500,
        )
...
def get_reserva(token):
    try:
        ...
        return error(
            "500",
            "Internal Server Error",
            f"Ocurrio un error al obtener la reserva: {err}",
            500,
        )
...
def cancelar_reserva(token):
    try:
        ...
        return error(
            "404", "Not Found", f"Reserva no encontrada o ya cancelada: {err}", 404
        )
    except mysql.connector.Error as err:
        return error(
            "500",
        ...
        return error(
            "500",
            "Internal Server Error",
            f"Ocurrio un error al cancelar la reserva: {err}",
            500,
        )
...
def consumir_reserva():
    ...
    try:
        ...
        return error(
            "404", "Not Found", f"Reserva no encontrada o invalida: {err}", 404
        )
    except mysql.connector.Error as err:
        return error(
            "500",
        ...
        return error(
            "500",
            "Internal Server Error",
            f"Ocurrio un error al consumir la reserva: {err}",
            500,
        )
...
def get_reservas():
    ...
    try:
        ...
        return error(
            "500",
            "Internal Server Error",
            f"Ocurrio un error al obtener las reservas:{err}",
            500,
        )
